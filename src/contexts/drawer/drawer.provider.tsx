...
type ActionType =
  ...
  | { type: 'OPEN_THANK_YOU_MODAL'; payload: any };

type StateType = typeof INITIAL_STATE;

function reducer(state: StateType, action: ActionType) {switch (action.type) {
    ...
    case 'OPEN_THANK_YOU_MODAL':
      return {
        ...state,
        showThankYouModal: action.payload.thankYouModal
      }
    default:
      return state;
  }
