...
export const cartItemsTotalQuantity = (items) => {
    let total = items.reduce((quantity, product) => {
...
export const cartItemsTotalBox = (items) => {
    let total = items.reduce((box, product) => {
        return box + product.boxCapacity * product.quantity;
    }, 0);
