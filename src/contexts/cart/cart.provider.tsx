...
import {reducer, cartItemsTotalPrice, cartItemsTotalQuantity, cartItemsTotalBox} from './cart.reducer';
...
const useCartActions = (initialCart = INITIAL_STATE) => {
  ...
  const getCartItemsQuantity = () => cartItemsTotalQuantity(state.items);
  const getCartItemsBox = () => cartItemsTotalBox(state.items);
  ...
  const getCartState = state.items.length ? true : false;
  ...
  return (
    <CartContext.Provider
      value={{
        ...
        calculateTotalQuantity: getCartItemsQuantity,
        calculateTotalBox: getCartItemsBox,
